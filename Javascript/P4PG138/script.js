function reset() {
    ...
    document.getElementById('m1').innerHTML = null
    document.getElementById('n2').innerHTML = null
    document.getElementById('n5').innerHTML = null
    document.getElementById('n10').innerHTML = null
    document.getElementById('n20').innerHTML = null
    document.getElementById('n50').innerHTML = null
    document.getElementById('n100').innerHTML = null
    document.getElementById('n200').innerHTML = null
}
...
function calcularNumerario(){
    ...
    document.getElementById("mensagem").innerHTML = "Olá Funcionário: " + id + "O Seu salário é de " + stotal
